 ...
 * @version $Id$
 */
public abstract class MySolutionModel<L extends Comparable, P> extends SolutionModel
{
  // ------------------------------ FIELDS ------------------------------
  ...
  public static SolutionModel identifyTypeAndLoad(String model_file_name, String ontFile, String dataFile) {
    try
    {
      ...
      // BAD quick hack
      Class c = MyBinaryModel.class ;
      LabelParser labelParser = new MyLabelParser() ;


      SolutionModel model =
	(SolutionModel) (c.getConstructor(Properties.class, LabelParser.class, String.class, String.class).newInstance(props, labelParser, ontFile, dataFile));
  ...
  public static MySolutionModel identifyTypeAndLoad(String model_file_name)
  {
    try
    {
      BufferedReader fp = new BufferedReader(new FileReader(model_file_name));
